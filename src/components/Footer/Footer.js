import "./Footer.css";
import telegram from "../media/insta.png";
import whatsapp from "../media/whatsap.png";
    ...
    <div className="footer" id="contacts">
      <div className="footer_wrapper">
        <div className="left_footer">
          ...
          <div className="social_madia">
            <div className="tel_div">
              <a href="https://t.me/StanimirStaykov">
                <img src={telegram} className="telegram" alt="telegram" />
              </a>
              <p className="tel_text">instagram</p>
            </div>
        ...
        <div className="right_footer">
          ...
          <p className="address">
            Römerberg <br></br> 60311 Frankfurt am Main
          </p>
