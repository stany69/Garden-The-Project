        ...
        <div className="father_ofTwo">
          ...
          <div className="descr_container">
            <div className="prices">
              <p className="discount_price item_d-price">
                {oneProduct?.discont_price} €
              </p>
              <p className="orig_prices item_or-price">{oneProduct?.price} €</p>
              <p className="percentage item_percentage">
                {Math.round(
                  ((oneProduct?.price - oneProduct?.discont_price) /
                    oneProduct?.price) *
                    100
                )}{" "}
                %
            ...
            <button
              className="item_btn"
              onClick={() => dispatch(AddProductsBasketAction(oneProduct))}
            >
              Add to Basket
            </button>
